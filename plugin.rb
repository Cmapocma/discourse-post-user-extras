...
after_initialize do
  ...
  register_editable_user_custom_field [:see_groups_icon, :see_badges_icon, :see_signatures, :signature_raw, :img_signature_no_smoking_1, :img_signature_no_smoking_2, :img_signature_no_smoking_3, :img_signature_no_smoking_4, :img_signature_no_smoking_5, :img_signature_no_smoking_6, :signature_no_smoking_text, :signature_no_smoking, :signature_no_drink, :signature_proper_nutrition, :signature_fitnes, :signature_clear_home, :signature_hobby]
    ...
    add_to_serializer(:post, :post_user_extras, false) {
      if object.user == nil then
      ...
      else
        {
          ...
          img_signature_no_smoking_6: object.user.custom_fields['img_signature_no_smoking_6'],
